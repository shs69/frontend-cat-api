...
export function CatCard({ cat, isFavorite, onToggleFavorite }: CatCardProps) {
	return (
		<article className="group relative overflow-hidden bg-white shadow-[0_1px_4px_rgba(0,0,0,0.18)] transition-transform duration-200 ease-out will-change-transform hover:z-10 hover:-translate-y-1 hover:scale-[1.075] hover:shadow-[0_10px_24px_rgba(0,0,0,0.)]">
			<img
				src={cat.url}
				alt="Котик"
				loading="lazy"
